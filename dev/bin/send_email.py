                ...
                with open(lf, 'r') as f:
                    ...
                    for val in reader['path']:
                        ...
                        if ( final_path_err == 0 ):
                            ...
                            subject = '!!! Automated email, Please do not reply !!!'
                            mail_body = "The path entered in the tool contains special characters which application is not able to process. Kindly enter correct path. " 
                            send_email(subject, mail_body, sendingaddr, fromaddr)
                            logger.error("Path %s has special characters...unable to decode", pth )
            try:
                os.remove(lf)
